                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @else
                      <a class="updateSubadminStatus" id="subadmin-{{ $subadmin->id }}" subadmin_id="{{ $subadmin->id }}" style="color:#B22222" href="javascript:void(0)">
                        <i class="fas fa-toggle-off" status="Inactive"></i>
                      </a>
                      @endif
                      &nbsp;&nbsp;
                      <a style="color:#B22222" class="confirmDelete" name="Subadmin" title="Delete Subadmin" href="javascrip:void(0)" record="subadmin" recordid="{{ $subadmin->id }}" <?php /* href="{{ url('admin/delete-cms-page/'.$page['id'])}}" */ ?>>
