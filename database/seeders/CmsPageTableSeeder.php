...
class CmsPageTableSeeder extends Seeder
{
    ...
    {
        $cmsPagesRecords = [
            ['id'=>100, 'title'=>'About Us', 'description'=>'content is coming soon', 'url'=>'about-us', 'meta_title'=>'About Us', 'meta_description'=>'About Us Content', 'meta_keywords'=>'about us, about', 'status'=>1 ],
